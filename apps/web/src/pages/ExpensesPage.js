...
export function ExpensesPage() {
    ...
    return (_jsxs("section", { className: "card", children: [_jsx("h2", { children: "Expenses" }), _jsx("p", { className: "pg-sub", style: { marginBottom: "1rem", fontSize: "0.65rem", color: "var(--text-dim)" }, children: "Track operating expenses by date" }), list.error ? _jsx("p", { className: "error", children: list.error.message }) : null, _jsxs("div", { className: "stats-row", style: { gridTemplateColumns: "repeat(2, 1fr)" }, children: [_jsxs("div", { className: "stat-box", children: [_jsx("div", { className: "stat-lbl", children: "Total expenses" }), _jsx("div", { className: "stat-val", children: items.length })] }), _jsxs("div", { className: "stat-box", children: [_jsx("div", { className: "stat-lbl", children: "Total cost" }), _jsxs("div", { className: "stat-val", children: ["$", totalCost.toFixed(2)] })] })] }), _jsx("div", { style: { display: "flex", justifyContent: "flex-end", marginBottom: "1rem" }, children: _jsx("button", { type: "button", className: "btn btn-gold", onClick: () => setModalOpen(true), children: "+ Add expense" }) }), _jsx("div", { className: "tbl-wrap", children: _jsxs("table", { className: "tbl", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Date" }), _jsx("th", { children: "Description" }), _jsx("th", { children: "Cost" }), _jsx("th", {})] }) }), _jsx("tbody", { children: items.length === 0 ? (_jsx("tr", { children: _jsx("td", { colSpan: 4, className: "tbl-empty", children: "No expenses recorded" }) })) : (items.map((i) => (_jsxs("tr", { children: [_jsx("td", { children: new Date(i.date + "T12:00:00").toLocaleDateString("en-US", {
                                            month: "short",
                                            day: "numeric",
                                            year: "numeric"
