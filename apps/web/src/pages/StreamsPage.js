...
export function StreamsPage() {
    ...
    return (_jsxs("section", { className: `card${activeStreamId ? " stream-session-card" : ""}`, children: [_jsx("h2", { children: "Streams" }), !activeStreamId ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "grid-form", children: [_jsxs("select", { value: goldBatchId, onChange: (e) => setGoldBatchId(e.target.value), children: [_jsx("option", { value: "", children: "Gold raw batch" }), (batches.data ?? [])
                                        ...
                                        .map((b) => (_jsxs("option", { value: b.id, children: [b.batch_name, " \u00B7 ", Number(b.remaining_grams).toFixed(4), "g"] }, b.id)))] })] }), _jsx("button", { type: "button", className: "btn btn-gold", style: { marginTop: "0.75rem" }, onClick: () => startMutation.mutate(), disabled: !user || startMutation.isPending, children: "Start stream" })] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { className: "stream-live-bar", children: [_jsx("span", { className: "stream-live-dot", "aria-hidden": true }), _jsx("span", { className: "stream-live-label", children: "LIVE" })] }), _jsx("p", { style: { fontSize: "0.65rem", color: "var(--muted)", marginBottom: "0.75rem" }, children: "Session active \u00B7 add sales below" }), _jsxs("div", { className: "grid-form", children: [_jsx("input", { value: stickerCode, onChange: (e) => setStickerCode(e.target.value), placeholder: "sticker code" }), _jsx("button", { type: "button", onClick: () => stickerMutation.mutate(), disabled: stickerMutation.isPending, children: "Add sticker sale" }), _jsxs("select", { value: rawMetal, onChange: (e) => setRawMetal(e.target.value), children: [_jsx("option", { value: "gold", children: "Gold" }), _jsx("option", { value: "silver", children: "Silver" })] }), _jsx("input", { value: rawWeight, onChange: (e) => setRawWeight(e.target.value), placeholder: "raw grams" }), _jsx("button", { type: "button", onClick: () => rawMutation.mutate(), disabled: rawMutation.isPending, children: "Add raw sale" })] })] })), _jsxs("p", { style: { fontSize: "0.65rem", color: "var(--muted)", marginTop: "1rem" }, children: ["My stream records: ", streams.data?.length ?? 0] }), activeStreamId ? (_jsx("div", { className: "stream-card-footer", children: _jsx("button", { type: "button", className: "btn btn-outline stream-end-btn", disabled: endMutation.isPending, onClick: requestEnd, children: "End stream" }) })) : null] }));
}
