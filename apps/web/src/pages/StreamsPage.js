...
export function StreamsPage() {
    ...
    return (_jsxs("section", { className: `card${activeStreamId ? " stream-session-card" : ""}`, children: [_jsx("h2", { children: "Streams" }), !activeStreamId ? (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", className: "btn btn-gold", style: { marginTop: "0.75rem" }, onClick: () => setIsStartCardOpen(true), disabled: !user || startMutation.isPending, children: "Start stream" }), isStartCardOpen ? (_jsxs("div", { style: { marginTop: "0.75rem" }, children: [_jsxs("div", { className: "grid-form", children: [_jsxs("select", { value: goldBatchId, onChange: (e) => setGoldBatchId(e.target.value), children: [_jsx("option", { value: "", children: "Gold raw batch" }), (batches.data ?? [])
                                                    ...
                                                    .map((b) => (_jsxs("option", { value: b.id, children: [b.batch_name, " \u00B7 ", Number(b.remaining_grams).toFixed(4), "g"] }, b.id)))] })] }), !hasSelectedStartBatch ? (_jsx("p", { style: { fontSize: "0.65rem", color: "var(--muted)", marginTop: "0.5rem", marginBottom: 0 }, children: "Select at least one metal batch to start stream." })) : null, _jsxs("div", { style: { display: "flex", gap: "0.5rem", marginTop: "0.75rem" }, children: [_jsx("button", { type: "button", className: "btn btn-gold", onClick: () => startMutation.mutate(), disabled: !user || startMutation.isPending || !hasSelectedStartBatch, children: "Confirm" }), _jsx("button", { type: "button", className: "btn btn-outline", onClick: () => setIsStartCardOpen(false), disabled: startMutation.isPending, children: "Cancel" })] })] })) : null] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { className: "stream-live-bar", children: [_jsx("span", { className: "stream-live-dot", "aria-hidden": true }), _jsx("span", { className: "stream-live-label", children: "LIVE" })] }), _jsx("p", { style: { fontSize: "0.65rem", color: "var(--muted)", marginBottom: "0.75rem" }, children: "Session active \u00B7 add sales below" }), _jsxs("div", { className: "grid-form", children: [_jsx("input", { value: stickerCode, onChange: (e) => setStickerCode(e.target.value), placeholder: "sticker code", disabled: endMutation.isPending }), _jsx("button", { type: "button", onClick: () => stickerMutation.mutate(), disabled: stickerMutation.isPending || endMutation.isPending, children: "Add sticker sale" }), _jsxs("select", { value: rawMetal, onChange: (e) => setRawMetal(e.target.value), disabled: endMutation.isPending, children: [_jsx("option", { value: "gold", children: "Gold" }), _jsx("option", { value: "silver", children: "Silver" })] }), _jsx("input", { value: rawWeight, onChange: (e) => setRawWeight(e.target.value), placeholder: "raw grams", disabled: endMutation.isPending }), _jsx("button", { type: "button", onClick: () => rawMutation.mutate(), disabled: rawMutation.isPending || endMutation.isPending, children: "Add raw sale" })] })] })), _jsxs("p", { style: { fontSize: "0.65rem", color: "var(--muted)", marginTop: "1rem" }, children: ["My stream records: ", streams.data?.length ?? 0] }), activeStreamId ? (_jsx("div", { className: "stream-card-footer", children: _jsx("button", { type: "button", className: "btn btn-outline stream-end-btn", disabled: endMutation.isPending, onClick: requestEnd, children: "End stream" }) })) : null] }));
}
