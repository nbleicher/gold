...
export function InventoryMgmtPage() {
    ...
    return (_jsxs("section", { className: "card", children: [_jsx("h2", { children: "Orders" }), _jsx("p", { className: "pg-sub", style: {
